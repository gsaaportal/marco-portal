...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapView.active'
        db.add_column('learn_mapview', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Topic.active'
        db.add_column('learn_topic', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapView.active'
        db.delete_column('learn_mapview', 'active')

        # Deleting field 'Topic.active'
        db.delete_column('learn_topic', 'active')
