OpenLayers.CompassIcon = OpenLayers.Class(OpenLayers.Control, {
     ...
     */
    clone: function() {
        return new OpenLayers.CompassIcon(this.url,
                                   this.size,
                                   this.offset,
    ...
    draw: function(px) {
        ...
        {
            var id = OpenLayers.Util.createUniqueID("OL_MapIcon_");
    ...
    CLASS_NAME: "OpenLayers.Control.IconTest"
});
